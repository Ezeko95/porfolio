...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <Head>
        <title>Gianluca Cianchi portfolio</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <main className="bg-white px-10 dark:bg-gray-900 md:px-24 sm:px8 lg:px-40  hover:scroll-auto pt-5">
        <section className="min-h-screen md:flex md:flex-col">
          <nav className="py-10 mb-8 md:mb-2 md:pt-2 flex justify-between dark:text-white">
