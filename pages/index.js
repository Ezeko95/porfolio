...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40  hover:scroll-auto">
        ...
        <section>
          ...
          <div className="lg:flex gap-10">
            <div className="text-center shadow-2xl shadow-teal-500 p-10 rounded-xl my-10 dark:bg-yellow-50 flex-1 animate-wiggle animate-once animate-duration-[10000ms] animate-ease-in animate-normal animate-fill-both">
        ...
        <section className="py-10">
          ...
          <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap">
            <div className="basis-1/3 flex-1 animate-fade-up animate-once animate-ease-in animate-normal animate-fill-both">
              <a
